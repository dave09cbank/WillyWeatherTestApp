...
@Component
@ConditionalOnExpression("#{systemProperties['field']!=null && systemProperties['field'].equals('PRCP')}")
public class PrcpProcessorImpl extends Processor {

	@Override
	public List<String> process() {
		List<String> valueList = new ArrayList<>();
		for (String value : fileParser.getColumnValuesForHeaderFromFile()) {
			valueList.add(value.replaceAll("I", ""));
		}
		return valueList;
	}
